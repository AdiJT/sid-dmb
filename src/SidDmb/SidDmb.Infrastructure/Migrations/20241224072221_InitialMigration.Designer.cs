...
namespace SidDmb.Infrastructure.Migrations
{
    ...
    [Migration("20241224072221_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AktivitasDestinasiWisataDestinasiWisata", b =>
                {
                    b.Property<int>("DaftarAktivitasId")
                        .HasColumnType("integer");

                    b.Property<string>("DaftarDestinasiWisataId")
                        .HasColumnType("text");

                    b.HasKey("DaftarAktivitasId", "DaftarDestinasiWisataId");

                    b.HasIndex("DaftarDestinasiWisataId");

                    b.ToTable("AktivitasDestinasiWisataDestinasiWisata");
                });
            ...
            modelBuilder.Entity("DestinasiWisataFasilitasDestinasiWisata", b =>
                {
                    b.Property<string>("DaftarDestinasiWisataId")
                        .HasColumnType("text");
                    ...
                    b.HasKey("DaftarDestinasiWisataId", "DaftarFasilitasId");

                    b.HasIndex("DaftarFasilitasId");

                    b.ToTable("DestinasiWisataFasilitasDestinasiWisata");
                });
            ...
            modelBuilder.Entity("FasilitasSeniBudaya", b =>
                {
                    b.Property<string>("DaftarSeniBudayaId")
                        .HasColumnType("text");

                    b.Property<int>("FasilitasPertunjukanId")
                        .HasColumnType("integer");

                    b.HasKey("DaftarSeniBudayaId", "FasilitasPertunjukanId");

                    b.HasIndex("FasilitasPertunjukanId");

                    b.ToTable("FasilitasSeniBudaya");
                });

            modelBuilder.Entity("FasilitasSitusBudaya", b =>
                {
                    b.Property<int>("DaftarFasilitasId")
                        .HasColumnType("integer");

                    b.Property<string>("DaftarSitusBudayaId")
                        .HasColumnType("text");

                    b.HasKey("DaftarFasilitasId", "DaftarSitusBudayaId");

                    b.HasIndex("DaftarSitusBudayaId");

                    b.ToTable("FasilitasSitusBudaya");
                });

            modelBuilder.Entity("FasilitasUpacaraBudaya", b =>
                {
                    b.Property<string>("DaftarUpacaraBudayaId")
                        .HasColumnType("text");

                    b.Property<int>("FasilitasPendukungId")
                        .HasColumnType("integer");

                    b.HasKey("DaftarUpacaraBudayaId", "FasilitasPendukungId");

                    b.HasIndex("FasilitasPendukungId");

                    b.ToTable("FasilitasUpacaraBudaya");
                });

            modelBuilder.Entity("KegiatanPrimaKolaboratorKegiatanPrima", b =>
                {
                    ...
                    b.ToTable("KegiatanPrimaKolaboratorKegiatanPrima");
                });
            ...
            modelBuilder.Entity("SidDmb.Domain.MasterDataFunction.ModulBudaya.Fasilitas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SidDmb.Domain.MasterDataFunction.ModulWisata.DestinasiWisatas.AktivitasDestinasiWisata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AktivitasDestinasiWisata");
                });
            ...
            modelBuilder.Entity("SidDmb.Domain.MasterDataFunction.ModulWisata.DestinasiWisatas.FasilitasDestinasiWisata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("FasilitasDestinasiWisata");
                });
            ...
            modelBuilder.Entity("AktivitasDestinasiWisataDestinasiWisata", b =>
                {
                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulWisata.DestinasiWisatas.AktivitasDestinasiWisata", null)
                        .WithMany()
                        .HasForeignKey("DaftarAktivitasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulWisata.DestinasiWisatas.DestinasiWisata", null)
                        .WithMany()
                        .HasForeignKey("DaftarDestinasiWisataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DestinasiWisataFasilitasDestinasiWisata", b =>
                {
                    ...
                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulWisata.DestinasiWisatas.FasilitasDestinasiWisata", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FasilitasSeniBudaya", b =>
                {
                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulBudaya.SeniBudayas.SeniBudaya", null)
                        .WithMany()
                        .HasForeignKey("DaftarSeniBudayaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulBudaya.Fasilitas", null)
                        .WithMany()
                        .HasForeignKey("FasilitasPertunjukanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FasilitasSitusBudaya", b =>
                {
                    ...
                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulBudaya.SitusBudayas.SitusBudaya", null)
                        .WithMany()
                        .HasForeignKey("DaftarSitusBudayaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FasilitasUpacaraBudaya", b =>
                {
                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulBudaya.UpacaraBudayas.UpacaraBudaya", null)
                        .WithMany()
                        .HasForeignKey("DaftarUpacaraBudayaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulBudaya.Fasilitas", null)
                        .WithMany()
                        .HasForeignKey("FasilitasPendukungId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("KegiatanPrimaKolaboratorKegiatanPrima", b =>
                {
                    ...
                    b.HasOne("SidDmb.Domain.MasterDataFunction.ModulPrima.KegiatanPrimas.KolaboratorKegiatanPrima", null)
                        .WithMany()
